...
#
servers = [
    {name: 'sss-jira7', url: '192.168.1.1', method: 'ping'},
    {name: 'sss-jira6', url: 'https://www.google.com/', method: 'http'},
    {name: 'sss-confluence', url: 'https://www.stewardssolution.com', method: 'http'},
    {name: 'sss-stash', url: '192.168.1.100', method: 'ping'},
]
